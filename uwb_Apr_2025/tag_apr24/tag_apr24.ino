...
#define TAG_ADDR "7D:00:22:EA:82:60:3B:02"
...
void newRange()
{
    ...
    // Send JSON data whenever range is updated
    print_link(uwb_data);
}
...
void print_link(struct Link *p)
{
    ...
    // Create JSON object with links array
    Serial.print("{\"links\":[");
    ...
    while (temp->next != NULL)
    {
        ...
        // Print each anchor as a JSON object with A and R fields
        Serial.print("{\"A\":\"");
        // Use the short address directly
        Serial.print(temp->anchor_addr, HEX);  // Print in hexadecimal format
        Serial.print("\",\"R\":\"");
